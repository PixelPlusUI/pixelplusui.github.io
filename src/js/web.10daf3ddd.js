! function(t) {
    ...
    i.resize = E(u, k), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function(t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && C()
    }, s(i.ready), C(), t.exports = window.Webflow = i
}, function(t, e, n) {
    "use strict";
    var i = n(2)(n(6));
    window.tram = function(t) {
        ...
        z.transform && (Y.transform = [q], K = {
            ...
            skewX: [_],
            skewY: [_]
        }), z.transform && z.backface && (K.z = [x, "translateZ"], K.rotateZ = [_], K.scaleZ = [g], K.perspective = [y]);
        var Q = /ms/,
            J = /s|\./;
        return t.tram = e
    }(window.jQuery)
                ...
                ! function(e, n) {
                    ...
                    if (w) l.on("click", function(t) {
                        ...
                        v.on("click", function() {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), m.text(i.name), A() || _(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var i = {
                                    name: e.name,
                                    size: e.size
                                };
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, A() || x(n)
                    }
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function N(t, e) {
            if (!t.open) {
                ...
                var r = $(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (P(0, c), _.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e) p();
                else {
        ...
        function q(t, e) {
            if (t.open) {
                ...
                var n = t.config;
                if (("none" === n.animation || !l.support.transform || n.duration <= 0) && (e = !0), _.outro(0, t.el[0]), d.off("click" + m, t.outside), e) return l(t.menu).stop(), void u();
